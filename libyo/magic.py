...
----------------------------------------------------------------------
You need GNUWIN32 magic1.dll to use this on Windows
"""
...
import ctypes
import ctypes.util
from sys import version_info, path, platform, getfilesystemencoding
PY_MAJOR_VERSION = version_info[0]
if platform=="win32":
    path.append(os.path.join(".","share"))
OS_F_ENC=getfilesystemencoding()
...
class Magic:
    ...
    def from_buffer(self, buf):
        ...
        """
        c = magic_buffer(self.cookie, buf)
    ...
    def from_file(self, filename):
        ...
        if PY_MAJOR_VERSION >= 3:
            filename = filename.encode(OS_F_ENC)
        
        c = magic_file(self.cookie, filename)
